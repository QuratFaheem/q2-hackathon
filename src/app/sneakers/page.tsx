...
import { Getsneakers } from "@/sanity/sanity.query";
import Link from "next/link";
import Image from "next/image";

export default async function Sneakers() {
  // Call the Getsneakers function to fetch the data
  const productsData = await Getsneakers(); // Fix: Invoke the function
  const products = productsData; // Assume Getsneakers returns an array of products
